...
context(a: ValueIntAdapter<T>) inline fun <T, C : MutableCollection<T>> IndexedCollectionVInt<T>.filterNotIndexedTo(destination: C, crossinline predicate: (Int, T) -> Boolean): C = filterIndexedTo(destination) { i, e->!predicate(i,e) }
