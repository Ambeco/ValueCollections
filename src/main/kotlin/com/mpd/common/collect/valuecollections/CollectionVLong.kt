...
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.anyIndexed(crossinline predicate: (index:Int, T) -> Boolean): Boolean = anyIndexedBits { i, e-> predicate(i,a.fromLong(e)) } != NULL_VALUE
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.allIndexed(crossinline predicate: (index:Int, T) -> Boolean): Boolean = allIndexedBits { i, e-> predicate(i,a.fromLong(e)) }
...
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.filter(crossinline predicate: (T) -> Boolean): ArrayListVLong<T> = filterTo(ArrayListVLong(), predicate)
...
context(a: ValueLongAdapter<T>) inline fun <T, C : MutableCollection<T>> CollectionVLong<T>.filterTo(destination: C, crossinline predicate: (T) -> Boolean): C = destination.also { forEach { if (predicate(it)) destination.add(it) } }
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.filterNot(crossinline predicate: (T) -> Boolean): ArrayListVLong<T> = filter {!predicate(it)}
...
context(a: ValueLongAdapter<T>) inline fun <T, C : MutableCollection<T>> CollectionVLong<T>.filterNotTo(destination: C, crossinline predicate: (T) -> Boolean): C = filterTo(destination) {!predicate(it)}
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVIntInt(crossinline transform: (T) -> PairVIntInt<K, V>): MapVIntInt<K, V> = associateTo(HashMapVIntInt(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVIntLong(crossinline transform: (T) -> PairVIntLong<K, V>): MapVIntLong<K, V> = associateTo(HashMapVIntLong(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVLongInt(crossinline transform: (T) -> PairVLongInt<K, V>): MapVLongInt<K, V> = associateTo(HashMapVLongInt(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVLongLong(crossinline transform: (T) -> PairVLongLong<K, V>): MapVLongLong<K, V> = associateTo(HashMapVLongLong(size), transform)
...
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVIntInt(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVIntInt<K,V> = associateTo(HashMapVIntInt(size), keySelector,valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVIntLong(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVIntLong<K,V> = associateTo(HashMapVIntLong(size), keySelector,valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVLongInt(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVLongInt<K,V> = associateTo(HashMapVLongInt(size), keySelector,valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVLongLong(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVLongLong<K,V> = associateTo(HashMapVLongLong(size), keySelector,valueTransform)
...
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVIntInt<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVIntInt<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVIntLong<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVIntLong<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVLongInt<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVLongInt<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVLongLong<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVLongLong<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
...
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>,) inline fun <T, K> CollectionVLong<T>.associateByVIntLong(crossinline keySelector: (T) -> K): MutableMapVIntLong<K,T> = associateTo(HashMapVIntLong<K,T>(size), keySelector, {it})
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K> CollectionVLong<T>.associateByVLongLong(crossinline keySelector: (T) -> K): MutableMapVLongLong<K,T> = associateTo(HashMapVLongLong<K,T>(size), keySelector,{it})
...
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, C:MutableMapVIntLong<K,T>> CollectionVLong<T>.associateByVIntLongTo(destination: C, crossinline keySelector: (T) -> K): MutableMapVIntLong<K,T> = associateTo(destination, keySelector, {it})
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, C:MutableMapVLongLong<K,T>> CollectionVLong<T>.associateByVLongLongTo(destination: C, crossinline keySelector: (T) -> K): MutableMapVLongLong<K,T> = associateTo(destination, keySelector,{it})
...
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K> CollectionVLong<T>.associateVIntFloat(crossinline transform: (T) -> PairVIntObj<K, Float>): MutableMapVIntFloat<K> = associateTo(HashMapVIntFloat(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K> CollectionVLong<T>.associateVLongFloat(crossinline transform: (T) -> PairVLongObj<K, Float>): MutableMapVLongFloat<K> = associateTo(HashMapVLongFloat(size), transform)
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, V> CollectionVLong<T>.associateVFloatInt(crossinline transform: (T) -> PairVObjInt<Float, V>): MutableMapVFloatInt<V> = associateTo(HashMapVFloatInt(size), transform)
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, V> CollectionVLong<T>.associateVFloatLong(crossinline transform: (T) -> PairVObjLong<Float, V>): MutableMapVFloatLong<V> = associateTo(HashMapVFloatLong(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, V> CollectionVLong<T>.associateVIntObj(crossinline transform: (T) -> PairVIntObj<K, V>): MutableMapVIntObj<K,V> = associateTo(HashMapVIntObj(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, V> CollectionVLong<T>.associateVLongObj(crossinline transform: (T) -> PairVLongObj<K, V>): MutableMapVLongObj<K,V> = associateTo(HashMapVLongObj(size), transform)
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVObjInt(crossinline transform: (T) -> PairVObjInt<K, V>): MutableMapVObjInt<K,V> = associateTo(HashMapVObjInt(size), transform)
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVObjLong(crossinline transform: (T) -> PairVObjLong<K, V>): MutableMapVObjLong<K,V> = associateTo(HashMapVObjLong(size), transform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K> CollectionVLong<T>.associateVIntFloat(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> Float): MutableMapVIntFloat<K> = associateTo(HashMapVIntFloat(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K> CollectionVLong<T>.associateVLongFloat(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> Float): MutableMapVLongFloat<K> = associateTo(HashMapVLongFloat(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, V> CollectionVLong<T>.associateVFloatInt(crossinline keySelector: (T) -> Float, crossinline valueTransform: (T) -> V): MutableMapVFloatInt<V> = associateTo(HashMapVFloatInt(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, V> CollectionVLong<T>.associateVFloatLong(crossinline keySelector: (T) -> Float, crossinline valueTransform: (T) -> V): MutableMapVFloatLong<V> = associateTo(HashMapVFloatLong(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, V> CollectionVLong<T>.associateVIntObj(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVIntObj<K,V> = associateTo(HashMapVIntObj(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, V> CollectionVLong<T>.associateVLongObj(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVLongObj<K,V> = associateTo(HashMapVLongObj(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVObjInt(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVObjInt<K,V> = associateTo(HashMapVObjInt(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVLong<T>.associateVObjLong(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVObjLong<K,V> = associateTo(HashMapVObjLong(size), keySelector, valueTransform)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, C:MutableMapVIntFloat<K>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVIntObj<K, Float>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, C:MutableMapVLongFloat<K>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVLongObj<K, Float>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, V, C:MutableMapVFloatInt<V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVObjInt<Float, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, V, C:MutableMapVFloatLong<V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVObjLong<Float, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, V, C:MutableMapVIntObj<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVIntObj<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, V, C:MutableMapVLongObj<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVLongObj<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVObjInt<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVObjInt<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVObjLong<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline transform: (T) -> PairVObjLong<K, V>): C = destination.also{ c-> c.putAll(this, transform) }
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, C:MutableMapVIntFloat<K>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> Float): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, C:MutableMapVLongFloat<K>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> Float): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, V, C:MutableMapVFloatInt<V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> Float, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, V, C:MutableMapVFloatLong<V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> Float, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, V, C:MutableMapVIntObj<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, V, C:MutableMapVLongObj<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVObjInt<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
context(a: ValueLongAdapter<T>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVObjLong<K,V>> CollectionVLong<T>.associateTo(destination: C, crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): C = destination.also{ c->c.putAll(this, keySelector,valueTransform)}
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.flatMapGeneric(crossinline transform: (T) ->Iterable<R>): MutableList<R> = flatMapTo(ArrayList(size*2), transform)
context(a: ValueLongAdapter<T>) inline fun <T, R, C : MutableCollection<R>> CollectionVLong<T>.flatMapTo(destination: C, crossinline transform: (T) ->Iterable<R>): C = destination.also{forEach { destination.addAll(transform(it)) }}
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.flatMapIndexed(crossinline transform: (Int, T) ->CollectionVInt<R>): ArrayListVInt<R> = flatMapIndexedTo(ArrayListVInt(size*2), transform)
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.flatMapIndexed(crossinline transform: (Int, T) ->CollectionVLong<R>): ArrayListVLong<R> = flatMapIndexedTo(ArrayListVLong(size*2), transform)
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.flatMapIndexedGeneric(crossinline transform: (Int, T) ->Iterable<R>): MutableList<R> = flatMapIndexedTo(ArrayList(size*2), transform)
context(a: ValueLongAdapter<T>) inline fun <T, R, C : MutableCollection<R>> CollectionVLong<T>.flatMapIndexedTo(destination: C, crossinline transform: (Int, T) ->Iterable<R>): C = destination.also{forEachIndexed { i, e-> destination.addAll(transform(i,e)) }}
context(a: ValueLongAdapter<T>) inline fun <T, K> CollectionVLong<T>.groupByGeneric(crossinline keySelector: (T) -> K): MutableMap<K, MutableListVLong<T>> = groupByGenericTo(HashMap<K,MutableListVLong<T>>(), keySelector)
context(a: ValueLongAdapter<T>) inline fun <T, K, M : MutableMap<K, MutableListVLong<T>>> CollectionVLong<T>.groupByGenericTo(destination: M, crossinline keySelector: (T) -> K): M = destination.also{ c-> forEach { c.getOrPut(keySelector(it),{ ArrayListVLong(size) }).add(it) }}
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K> CollectionVLong<T>.groupByVIntObj(crossinline keySelector: (T) -> K): MutableMapVIntObj<K, MutableListVLong<T>> = groupByVIntObjTo(HashMapVIntObj(), keySelector)
context(a: ValueLongAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, C : MutableMapVIntObj<K, MutableListVLong<T>>> CollectionVLong<T>.groupByVIntObjTo(destination: C, crossinline keySelector: (T) -> K): C = destination.also{ c-> forEach { c.getOrPut(keySelector(it),{ ArrayListVLong(size) }).add(it) }}
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K> CollectionVLong<T>.groupByVLongObj(crossinline keySelector: (T) -> K): MutableMapVLongObj<K, MutableListVLong<T>> = groupByVLongObjTo(HashMapVLongObj(), keySelector)
context(a: ValueLongAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, C : MutableMapVLongObj<K, MutableListVLong<T>>> CollectionVLong<T>.groupByVLongObjTo(destination: C, crossinline keySelector: (T) -> K): C = destination.also{ c-> forEach { c.getOrPut(keySelector(it),{ ArrayListVLong(size) }).add(it) }}
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.mapNotNullGeneric(crossinline transform: (T) -> R?): List<R> = mapNotNullTo(mutableListOf(), transform)
...
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<R>) inline fun <T, R, C : MutableCollectionVInt<R>> CollectionVLong<T>.mapNotNullTo(destination: C, crossinline transform: (T) -> R?): C = destination.also {forEach{transform(it)?.also {destination.add(it) } }}
context(a: ValueLongAdapter<T>, ra: ValueLongAdapter<R>) inline fun <T, R, C : MutableCollectionVLong<R>> CollectionVLong<T>.mapNotNullTo(destination: C, crossinline transform: (T) -> R?): C = destination.also {forEach{transform(it)?.also {destination.add(it) } }}
...
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.withIndexGeneric():Collection<IndexedVLong<T>> = mapIndexedGeneric{ i, e-> IndexedVLong.of(i,e)}
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.foldIndexed(initial: R, crossinline operation: (index: Int, acc: R, T) -> R): R = foldIndexedBits(initial) { i, acc, e -> operation(i, acc, a.fromLong(e)) }
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.maxOfWith(comparator: Comparator<in R>, crossinline selector: (T) -> R): R = mapReduce(selector) { max, e-> if (comparator.compare(e,max)>0) e else max}
...
context(a: ValueLongAdapter<T>) inline fun <T, R : Comparable<R>> CollectionVLong<T>.sortedBy(crossinline selector: (T) -> R?): ArrayListVLong<T> =  toMutableList().also{it.sortBy(selector)}
context(a: ValueLongAdapter<T>) inline fun <T, R : Comparable<R>> CollectionVLong<T>.sortedByDescending(crossinline selector: (T) -> R?): ArrayListVLong<T> = toMutableList().also{it.sortByDescending(selector)}
context(a: ValueLongAdapter<T>) inline fun <T: Comparable<T>> CollectionVLong<T>.sortedDescending(): ArrayListVLong<T> = toMutableList().also{it.sortDescending()}
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.sortedWith(comparator: Comparator<in T>): ArrayListVLong<T> = toMutableList().also{it.sortWith(comparator)}
...
context(a: ValueLongAdapter<T>) inline fun <T, R> CollectionVLong<T>.chunked(size: Int, crossinline transform: (ListVLong<T>) -> R): List<R> = chunked(size).map(transform)
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.plusElement(element: T): ListVLong<T> = plus(element)
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.plus(element: T): ListVLong<T> = ArrayListVLong<T>(size+1).also {it.addAll(this); it.add(element) }
 inline operator fun <T> CollectionVLong<T>.plus(elements: CollectionVLong<T>): ListVLong<T> = ArrayListVLong<T>(size+elements.size).also {it.addAll(this); it.addAll(elements) }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.plus(elements: Iterable<T>): ListVLong<T> = ArrayListVLong<T>(size+1).also {it.addAll(this); it.addAll(elements) }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.plus(elements: Array<out T>): ListVLong<T> = ArrayListVLong<T>(size+1).also {it.addAll(this); it.addAll(elements) }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.minus(element: T): ListVLong<T> = ArrayListVLong<T>(size).also { c-> forEach { if (it != element) c.add(it) } }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.minus(elements: Array<out T>): ListVLong<T> = ArrayListVLong<T>(size).also { c-> forEach { if (!elements.contains(it)) c.add(it) } }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.minus(elements:CollectionVLong<T>): ListVLong<T> = ArrayListVLong<T>(size).also { c-> forEach { if (!elements.contains(it)) c.add(it) } }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.minus(elements:Iterable<T>): ListVLong<T> = ArrayListVLong<T>(size).also { c-> forEach { if (!elements.contains(it)) c.add(it) } }
context(a: ValueLongAdapter<T>) inline operator fun <T> CollectionVLong<T>.minus(elements: Sequence<T>): ListVLong<T> = ArrayListVLong<T>(size).also { c-> forEach { if (!elements.contains(it)) c.add(it) } }
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.minusElement(element: T): ListVLong<T> = minus(element)
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.partition(crossinline predicate: (T) -> Boolean): Pair<ListVLong<T>, ListVLong<T>> {
    val trueList = ArrayListVLong<T>(size)
    val falseList = ArrayListVLong<T>(size)
...
context(a: ValueLongAdapter<T>) inline infix fun <T, R> CollectionVLong<T>.zipGeneric(other: Array<out R>): MutableList<Pair<T, R>> = zipGeneric(other, { a, b->a to b})
context(a: ValueLongAdapter<T>) inline fun <T, R, V> CollectionVLong<T>.zipGeneric(other: Array<out R>, crossinline transform: (a: T, b: R) -> V): MutableList<V> {
...
// PairVLongLong<T,R> (Long+Long, 128 bits) and PairVLongInt<T,R> (Long+Int, 96 bits) can't be bit-packed into a
// single LongBits either (only Int+Int, i.e. PairVIntInt, fits), so neither has a ValueLongAdapter/ValueIntAdapter.
// Same fallback as in CollectionVInt.kt: expose these two combinations as "Generic"-suffixed boxed-List zips.
context(ta: ValueLongAdapter<T>, ra: ValueIntAdapter<R>, va: ValueLongAdapter<V>) inline fun <T, R, V> CollectionVLong<T>.zipPairVLongInt(other:IndexedCollectionVInt<R>, crossinline transform: (a: T, b: R) -> V): MutableListVLong<V> {
    val r = ArrayListVLong<V>(min(size, other.size))
    forEachIndexed { i, e -> if (i < other.size) r.add(i, transform(e, other.get(i))) }
    return r
}
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<R>) inline infix fun <T, R> CollectionVLong<T>.zipGeneric(other:IndexedCollectionVInt<R>): MutableList<Pair<T, R>> = zipGeneric(other, { a, b->a to b})
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<R>) inline fun <T, R, V> CollectionVLong<T>.zipGeneric(other:IndexedCollectionVInt<R>, crossinline transform: (a: T, b: R) -> V): MutableList<V> {
    val r = mutableListOf<V>()
    forEachIndexed { i, e -> if (i < other.size) r.add(i, transform(e, other.get(i))) }
    return r
}
context(a: ValueLongAdapter<T>, ra: ValueLongAdapter<R>) inline infix fun <T, R> CollectionVLong<T>.zipGeneric(other:IndexedCollectionVLong<R>): MutableList<Pair<T, R>> = zipGeneric(other, { a, b->a to b})
context(a: ValueLongAdapter<T>, ra: ValueLongAdapter<R>) inline fun <T, R, V> CollectionVLong<T>.zipGeneric(other:IndexedCollectionVLong<R>, crossinline transform: (a: T, b: R) -> V): MutableList<V> {
    val r = mutableListOf<V>()
    forEachIndexed { i, e -> if (i < other.size) r.add(i, transform(e, other.get(i))) }
    return r
}
...
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<R>) inline fun <T, R> CollectionVLong<T>.runningFoldVInt(initial: R, crossinline operation: (acc: R, T) -> R): MutableListVInt<R> = runningFoldVIntIndexed(initial) { i, acc, e->operation(acc,e)}
context(ta: ValueLongAdapter<T>, ra: ValueIntAdapter<R>) inline fun <T, R> CollectionVLong<T>.runningFoldVIntIndexed(initial: R, crossinline operation: (index: Int, acc: R, T) -> R): MutableListVInt<R> {
    val accumulator = object: (Int,T)->Unit {
        var acc = initial
...
context(a: ValueLongAdapter<T>, ra: ValueLongAdapter<R>) inline fun <T, R> CollectionVLong<T>.runningFoldVLong(initial: R, crossinline operation: (acc: R, T) -> R): MutableListVLong<R> = runningFoldVLongIndexed(initial) { i, acc, e->operation(acc,e)}
context(ta: ValueLongAdapter<T>, ra: ValueLongAdapter<R>) inline fun <T, R> CollectionVLong<T>.runningFoldVLongIndexed(initial: R, crossinline operation: (index: Int, acc: R, T) -> R): MutableListVLong<R> {
    val accumulator = object: (Int,T)->Unit {
        var acc = initial
...
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<S>) inline fun <S, T : S> CollectionVLong<T>.runningReduceVInt(crossinline operation: (acc: S, T) -> S): MutableListVInt<S> = with(ra){runningReduceVIntIndexed { i, acc, e -> operation(acc,e)}}
context(a: ValueLongAdapter<T>, ra: ValueIntAdapter<S>) inline fun <S, T : S> CollectionVLong<T>.runningReduceVIntIndexed(crossinline operation: (index: Int, acc: S, T) -> S): MutableListVInt<S>  {
...
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.runningReduceVLong(crossinline operation: (acc: T, T) -> T): MutableListVLong<T> = runningReduceVLongIndexed { i, acc, e -> operation(acc,e)}
context(a: ValueLongAdapter<T>) inline fun <T> CollectionVLong<T>.runningReduceVLongIndexed(crossinline operation: (index: Int, acc: T, T) -> T): MutableListVLong<T> {
    if (size<=1) return ArrayListVLong()
    val accumulator = object: (Int,T)->Unit {
        var acc: T = findOrThrow{true}
        var result = ArrayListVLong<T>(size-1)
        override inline fun invoke(i:Int, e: T) {
            if (i ==0) return
            acc = operation(i-1, acc, e)
            result.add(acc)
