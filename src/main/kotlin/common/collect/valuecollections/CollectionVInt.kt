...
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVIntInt(crossinline transform: (T) -> VIntIntPair<K, V>): MapVIntInt<K, V> = associateTo(MutableMapVIntInt(size), transform)
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVIntLong(crossinline transform: (T) -> VIntLongPair<K, V>): MapVIntLong<K, V> = associateTo(MutableMapVIntLong(size), transform)
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVLongInt(crossinline transform: (T) -> VLongIntPair<K, V>): MapVLongInt<K, V> = associateTo(MutableMapVLongInt(size), transform)
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVLongLong(crossinline transform: (T) -> VLongLongPair<K, V>): MapVLongLong<K, V> = associateTo(MutableMapVLongLong(size), transform)
...
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVIntInt(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVIntInt<K,V> = associateTo(MutableMapVIntInt(size), keySelector,valueTransform)
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVIntLong(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVIntLong<K,V> = associateTo(MutableMapVIntLong(size), keySelector,valueTransform)
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVLongInt(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVLongInt<K,V> = associateTo(MutableMapVLongInt(size), keySelector,valueTransform)
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V> CollectionVInt<T>.associateVLongLong(crossinline keySelector: (T) -> K, crossinline valueTransform: (T) -> V): MutableMapVLongLong<K,V> = associateTo(MutableMapVLongLong(size), keySelector,valueTransform)
...
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVIntInt<K,V>> CollectionVInt<T>.associateTo(destination: C, crossinline transform: (T) -> VIntIntPair<K, V>): C = destination.also{ c->forEach {c.putAll(this, transform)}}
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVIntLong<K,V>> CollectionVInt<T>.associateTo(destination: C, crossinline transform: (T) -> VIntLongPair<K, V>): C = destination.also{ c->forEach {c.putAll(this, transform)}}
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueIntAdapter<V>) inline fun <T, K, V, C:MutableMapVLongInt<K,V>> CollectionVInt<T>.associateTo(destination: C, crossinline transform: (T) -> VLongIntPair<K, V>): C = destination.also{ c->forEach {c.putAll(this, transform)}}
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>, va: ValueLongAdapter<V>) inline fun <T, K, V, C:MutableMapVLongLong<K,V>> CollectionVInt<T>.associateTo(destination: C, crossinline transform: (T) -> VLongLongPair<K, V>): C = destination.also{ c->forEach {c.putAll(this, transform)}}
...
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>,) inline fun <T, K> CollectionVInt<T>.associateByVIntInt(crossinline keySelector: (T) -> K): MutableMapVIntInt<K,T> = associateTo(MutableMapVIntInt<K,T>(size), keySelector, {it})
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K> CollectionVInt<T>.associateByVLongInt(crossinline keySelector: (T) -> K): MutableMapVLongInt<K,T> = associateTo(MutableMapVLongInt(size), keySelector,{it})
...
context(a: ValueIntAdapter<T>, ka: ValueIntAdapter<K>) inline fun <T, K, C:MutableMapVIntInt<K,T>> CollectionVInt<T>.associateByVIntIntTo(destination: C, crossinline keySelector: (T) -> K): MutableMapVIntInt<K,T> = associateTo(MutableMapVIntInt<K,T>(size), keySelector, {it})
context(a: ValueIntAdapter<T>, ka: ValueLongAdapter<K>) inline fun <T, K, C:MutableMapVLongInt<K,T>> CollectionVInt<T>.associateByVLongIntTo(destination: C, crossinline keySelector: (T) -> K): MutableMapVLongInt<K,T> = associateTo(MutableMapVLongInt(size), keySelector,{it})
...
context(a: ValueIntAdapter<T>, ra: ValueIntAdapter<R>) inline infix fun <T, R> CollectionVInt<T>.zip(other:VIntIndexedCollection<R>): MutableVLongList<VIntIntPair<T, R>> 
...
context(ta: ValueIntAdapter<T>, ra: ValueIntAdapter<R>, va: ValueLongAdapter<V>) inline fun <T, R, V> CollectionVInt<T>.zipVIntIntPair(other:VIntIndexedCollection<R>, crossinline transform: (a: T, b: R) -> V): MutableVLongList<V> {
