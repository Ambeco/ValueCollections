...
interface ModifiableVLongIndexedCollection<T>: VLongIndexedCollection<T>, ModifiableCollectionVLong<T> {
...
interface MutableVLongIndexedCollection<T>: ModifiableVLongIndexedCollection<T>, MutableCollectionVLong<T> {
