...
class ListVIntTest {
    ...
    fun constructors() = with (LVIntTestClass) {
        ...
        val fromCollectionVInt: CollectionVInt<LVIntTestClass> = vIntSetOf(LVIntTestClass(1), LVIntTestClass(2))
    ...
    fun lastIndexAndIndices() = with (LVIntTestClass) {
        val list = vIntListOf(LVIntTestClass(1), LVIntTestClass(2), LVIntTestClass(3)) as ArrayListVInt<LVIntTestClass>
    ...
    fun vIntListOfArities() = with (LVIntTestClass) {
        ...
        val many = vIntListOf(LVIntTestClass(1), LVIntTestClass(2), LVIntTestClass(3), LVIntTestClass(4))
    ...
    fun mutableVIntListOfArities() = with (LVIntTestClass) {
        ...
        val many = mutableVIntListOf(LVIntTestClass(1), LVIntTestClass(2), LVIntTestClass(3), LVIntTestClass(4))
        assertEquals(listOf(LVIntTestClass(1), LVIntTestClass(2), LVIntTestClass(3), LVIntTestClass(4)), many.toListGeneric())
