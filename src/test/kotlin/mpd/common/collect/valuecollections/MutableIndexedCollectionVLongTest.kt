...
class MutableIndexedCollectionVLongTest {
    ...
    fun addAtIndex() = with (MutIdxColLongTestClass) {
        val list = ArrayListVLong<MutIdxColLongTestClass>().also { it += MutIdxColLongTestClass(1); it += MutIdxColLongTestClass(3) }
        list.addBits(1, 2)
        assertEquals(vLongListOf(MutIdxColLongTestClass(1), MutIdxColLongTestClass(2), MutIdxColLongTestClass(3)), list)
        list.add(0, MutIdxColLongTestClass(0))
        assertEquals(vLongListOf(MutIdxColLongTestClass(0), MutIdxColLongTestClass(1), MutIdxColLongTestClass(2), MutIdxColLongTestClass(3)), list)
    }
    ...
    fun addAllAtIndexNotYetImplemented() = with (MutIdxColLongTestClass) {
        val list = ArrayListVLong<MutIdxColLongTestClass>().also { it += MutIdxColLongTestClass(1) }
        assertThrows(NotImplementedError::class.java, { list.addAll(0, vLongListOf(MutIdxColLongTestClass(2))) })
    ...
    fun removeAtTyped() = with (MutIdxColLongTestClass) {
        val list = ArrayListVLong<MutIdxColLongTestClass>().also { it += MutIdxColLongTestClass(1); it += MutIdxColLongTestClass(2); it += MutIdxColLongTestClass(3) }
    ...
    fun removeAllIndexedBitsAndRetainAllNotYetImplemented() = with (MutIdxColLongTestClass) {
        val list = ArrayListVLong<MutIdxColLongTestClass>().also { it += MutIdxColLongTestClass(1); it += MutIdxColLongTestClass(2) }
        assertThrows(NotImplementedError::class.java, { list.removeAllIndexedBits { _, b -> b == 1L } })
        assertThrows(NotImplementedError::class.java, { list.retainAll(vLongListOf(MutIdxColLongTestClass(1))) })
    }

    @Test
    fun asListGenericFullCrud() = with (MutIdxColLongTestClass) {
        val backing = ArrayListVLong<MutIdxColLongTestClass>().also { it += MutIdxColLongTestClass(1); it += MutIdxColLongTestClass(2); it += MutIdxColLongTestClass(3) }
