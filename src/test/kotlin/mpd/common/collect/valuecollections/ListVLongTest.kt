...
class ListVLongTest {
    ...
    fun constructors() = with (LVLongTestClass) {
        val primary = ArrayListVLong<LVLongTestClass>(MutableLongList().also { it.add(1); it.add(2) })
        ...
        val fromCollectionVLong: CollectionVLong<LVLongTestClass> = vLongSetOf(LVLongTestClass(1), LVLongTestClass(2))
    ...
    fun capacity() = with (LVLongTestClass) {
        ...
        list += LVLongTestClass(1)
        assertEquals(true, list.capacity >= 1)
    }

    @Test
    fun setOperator() = with (LVLongTestClass) {
        val list = ArrayListVLong<LVLongTestClass>().also { it += LVLongTestClass(1); it += LVLongTestClass(2); it += LVLongTestClass(3) }
    ...
    fun vLongListOfArities() = with (LVLongTestClass) {
        ...
        val many = vLongListOf(LVLongTestClass(1), LVLongTestClass(2), LVLongTestClass(3), LVLongTestClass(4))
    ...
    fun mutableVLongListOfArities() = with (LVLongTestClass) {
        ...
        val many = mutableVLongListOf(LVLongTestClass(1), LVLongTestClass(2), LVLongTestClass(3), LVLongTestClass(4))
        assertEquals(listOf(LVLongTestClass(1), LVLongTestClass(2), LVLongTestClass(3), LVLongTestClass(4)), many.toListGeneric())
