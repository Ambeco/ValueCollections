...
class SetVLongTest {
    ...
    fun vLongSetOfArities() = with (SVLongTestClass) {
        ...
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2)), vLongSetOf(SVLongTestClass(1), SVLongTestClass(2)).toSetGeneric())
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3)), vLongSetOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3)).toSetGeneric())
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3), SVLongTestClass(4)), vLongSetOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3), SVLongTestClass(4)).toSetGeneric())
    }
    ...
    fun mutableSetVLongOfArities() = with (SVLongTestClass) {
        ...
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2)), mutableSetVLongOf(SVLongTestClass(1), SVLongTestClass(2)).toSetGeneric())
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3)), mutableSetVLongOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3)).toSetGeneric())
        assertEquals(setOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3), SVLongTestClass(4)), mutableSetVLongOf(SVLongTestClass(1), SVLongTestClass(2), SVLongTestClass(3), SVLongTestClass(4)).toSetGeneric())
