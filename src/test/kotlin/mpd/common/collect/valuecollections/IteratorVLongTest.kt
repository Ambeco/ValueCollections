...
class IteratorVLongTest {
    ...
    fun vIteratorFromDispatchMutable() = with (IterVLongTestClass) {
        assertEquals(true, vIteratorFrom<IterVLongTestClass>(RemovableOfLong(mutableListOf(1, 2)) as MutableIterator<Long>) is MutableIteratorVLongJava<IterVLongTestClass>)
        assertEquals(true, vIteratorFrom<IterVLongTestClass>(RemovableLongIterator(mutableListOf(1, 2)) as MutableIterator<Long>) is MutableIteratorVLongKotlin<IterVLongTestClass>)
        assertEquals(true, vIteratorFrom<IterVLongTestClass>(mutableListOf(1L, 2L).iterator()) is MutableIteratorVLongGeneric<IterVLongTestClass>)
    }
