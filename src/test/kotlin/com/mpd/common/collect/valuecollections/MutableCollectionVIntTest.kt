...
import com.mpd.common.collect.valuecollections.MutableCollectionVInt
...
class MutableCollectionVIntTest {
    ...
    private fun simpleSet(): ArraySetVInt<MutColTestClass> = with (MutColTestClass) {
        ArraySetVInt<MutColTestClass>(20).also { it plusAssign MutColTestClass(100); it += MutColTestClass(200); it += MutColTestClass(300) }
    }
    ...
    fun minusAssignVariants() = with (MutColTestClass) {
        ...
        single minusAssign MutColTestClass(100)
