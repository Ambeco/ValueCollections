...
import com.mpd.common.collect.valuecollections.IteratorVIntGeneric
import com.mpd.common.collect.valuecollections.IteratorVIntJava
import com.mpd.common.collect.valuecollections.IteratorVIntKotlin
import com.mpd.common.collect.valuecollections.ListIteratorVInt
import com.mpd.common.collect.valuecollections.MutableIteratorVIntGeneric
import com.mpd.common.collect.valuecollections.MutableIteratorVIntJava
import com.mpd.common.collect.valuecollections.MutableIteratorVIntKotlin
import com.mpd.common.collect.valuecollections.MutableListIteratorVInt
import com.mpd.common.collect.valuecollections.VIteratorIndexedValueInt
...
import com.mpd.common.collect.valuecollections.mutableVIteratorFrom
...
class IteratorVIntTest {
    ...
    fun vIteratorFromDispatch() = with (IterVIntTestClass) {
        assertEquals(true, vIteratorFrom<IterVIntTestClass>(
            Arrays.stream(intArrayOf(1, 2)).iterator()
        ) is IteratorVIntJava<IterVIntTestClass>
        )
        assertEquals(true, vIteratorFrom<IterVIntTestClass>(
            intArrayOf(
                1,
        ...
        ) is IteratorVIntKotlin<IterVIntTestClass>
        )
        assertEquals(true, vIteratorFrom<IterVIntTestClass>(
            listOf(
                1,
        ...
        ) is IteratorVIntGeneric<IterVIntTestClass>
        )
    }

    @Test
    fun mutableVIteratorFromDispatch() = with (IterVIntTestClass) {
        assertEquals(true, mutableVIteratorFrom<IterVIntTestClass>(
            RemovableOfInt(
                mutableListOf(
                    1,
                    2
        ...
        ) is MutableIteratorVIntJava<IterVIntTestClass>
        )
        assertEquals(true, mutableVIteratorFrom<IterVIntTestClass>(
            RemovableIntIterator(
                mutableListOf(1, 2)
            )
        ) is MutableIteratorVIntKotlin<IterVIntTestClass>
        )
        assertEquals(true, mutableVIteratorFrom<IterVIntTestClass>(
            mutableListOf(
                1,
        ...
        ) is MutableIteratorVIntGeneric<IterVIntTestClass>
        )
    }
