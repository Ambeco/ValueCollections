...
import com.mpd.common.collect.valuecollections.emptySetVInt
import com.mpd.common.collect.valuecollections.mutableSetVIntOf
...
class SetVIntTest {
    ...
    fun vIntSetOfArities() = with (SVIntTestClass) {
        ...
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2)), vIntSetOf(
            SVIntTestClass(1),
            SVIntTestClass(2)
        ).toSetGeneric())
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2), SVIntTestClass(3)), vIntSetOf(
            SVIntTestClass(1),
            SVIntTestClass(2),
            SVIntTestClass(3)
        ).toSetGeneric())
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2), SVIntTestClass(3), SVIntTestClass(4)), vIntSetOf(
            SVIntTestClass(1),
            SVIntTestClass(2),
            SVIntTestClass(3),
            SVIntTestClass(4)
    ...
    fun mutableSetVIntOfArities() = with (SVIntTestClass) {
        ...
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2)), mutableSetVIntOf(
            SVIntTestClass(1),
            SVIntTestClass(2)
        ).toSetGeneric())
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2), SVIntTestClass(3)), mutableSetVIntOf(
            SVIntTestClass(1),
            SVIntTestClass(2),
            SVIntTestClass(3)
        ).toSetGeneric())
        assertEquals(setOf(SVIntTestClass(1), SVIntTestClass(2), SVIntTestClass(3), SVIntTestClass(4)), mutableSetVIntOf(
            SVIntTestClass(1),
            SVIntTestClass(2),
            SVIntTestClass(3),
            SVIntTestClass(4)
